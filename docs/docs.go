...
const docTemplate = `{
    ...
    "paths": {
            ...
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/boilerplate-be_internal_pkg_response.BaseResponse"
                        }
                    },
                    "401": {
                        "description": "Unauthorized",
            ...
            "post": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "type": "string",
                        "description": "Upload type: image, document, or default",
                        "name": "type",
                        "in": "query"
                    }
                ],
        ...
        "/files/{id}": {
            ...
            "delete": {
                ...
                "parameters": [
                    ...
                    {
                        "type": "boolean",
                        "description": "Hard delete (permanently remove file)",
                        "name": "hard",
                        "in": "query"
                    }
                ],
        ...
        "/super-admin/audit-logs/cleanup": {
            "post": {
                "security": [
                    {
                        "BearerAuth": []
                ...
                "parameters": [
                    {
                        "type": "integer",
                        "default": 90,
                        "description": "Retention days (minimum 30)",
                        "name": "days",
                        "in": "query"
                    }
                ],
    ...
    "definitions": {
        "boilerplate-be_internal_pkg_response.BaseResponse": {
            "type": "object",
            "properties": {
                "code": {
                    "type": "integer"
                ...
                "meta": {
                    "$ref": "#/definitions/boilerplate-be_internal_pkg_response.MetaResponse"
                },
                "success": {
                    "type": "boolean"
                },
        ...
        "boilerplate-be_internal_pkg_response.MetaResponse": {
            "type": "object",
            "properties": {
                "is_back": {
                    "type": "boolean"
